...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \padd
    \noindent
    \exonviz is a tool to visualize transcripts with features
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Usage}{name=usage,below=introduction} {
    ...
    \begin{enumerate}[leftmargin=*]
      ...
      \item Click \textbf{Submit} to draw the figure, and \textbf{Download} the figure in SVG format
    \end{enumerate}
  }
  ...
  \headerbox{Features}{name=features,below=usage} {
    ...
    like exon frames, coding region and variants. All feature sizes and
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  % SHD figure
  \headerbox{\textit{SDHD} (NM\_003002.4), with variants}{name=SDHD,column=1,span=2} {
  \captionsetup{labelformat=empty,margin=0.6cm}
  \noindent{\centering\includegraphics[scale=0.82]{images/SDHD.png}\\}
  \captionof{figure}{Transcript NM\_003002.4 of \textit{SDHD}, with two variants}
  }

  % SHD noncoding
  \headerbox{\textit{SDHD} (NM\_003002.4),  non coding}{name=SDHDnon,column=1,span=2,aligned=usage} {
  \captionsetup{labelformat=empty,margin=0.6cm}
  \noindent{\centering\includegraphics[width=0.95\linewidth]{images/SDHD-non.png}\\}
  \captionof{figure}{Transcript NM\_003002.4 of \textit{SDHD}, with non-coding regions}
  }

  % DMD figure
  \headerbox{\textit{DMD}, schematic}{name=DMD,column=1,span=2,aligned=features} {
  \captionsetup{labelformat=empty,margin=0.6cm}
  ...
  % CYLD figure
  \headerbox{\textit{CYLD}, with variants from ClinVar}{name=CYLD,column=0,span=3,below=features} {
  \captionsetup{labelformat=empty,margin=0.6cm}
  \noindent{\centering\includegraphics[width=0.95\linewidth]{images/CYLD.png}\\}
  \captionof{figure}{Transcript NM\_001378743.1 of \textit{CYLD}, with all ClinVar variants by category}
  }
