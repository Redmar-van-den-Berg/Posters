...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \padd
    \noindent\textbf{ExonViz} is a tool to visualize transcripts, including features
    like coding and non-coding regions, variants and exon reading-frames.

    \noindent It is available online via \url{https://exonviz.rnatherapy.nl},
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Usage}{name=usage,below=introduction} {
    ...
    \begin{enumerate}
      ...
      \item Set the drawing options such as \option{scale}, \option{height} and the maximum \option{width} for the figure
      \item Set the exon and variant colors, and the variant shape (\option{pin} or \option{bar})
      \item Click \textbf{Submit} to draw the figure on screen, or use the \textbf{Download}
            button to download the figure in SVG format
    \end{enumerate}
  }
  ...
  \headerbox{Features}{name=features,below=usage} {
    \padd
    \begin{itemize}
      \item Draw transcripts including features like exon frames, coding region and variants for transcripts from any species
      \item All exon sizes and variant positions are biologically accurate
      \item Specify custom transcripts and variants via a simple Excel file
      \item Extensive online documentation with examples
      \item Figures generated with \textbf{ExonViz} are free to use for any purpose
    \end{itemize}
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \noindent{\centering\includegraphics[width=0.95\linewidth]{images/SDHD.png}\\}
  ...
  % CYLD figure
  \headerbox{CYLD variants from ClinVar}{name=CYLD,column=0,span=3,below=MM} {
  \captionsetup{labelformat=empty,margin=0.6cm}
